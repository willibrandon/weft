...
public static class ControlClientExtensions
{
    ...
    /// <summary>
    /// Calls events.subscribe; events then arrive on <see cref="ControlClient.Events"/>.
    /// </summary>
    /// <param name="client">The client.</param>
