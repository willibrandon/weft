...
public static class ProtocolEvents
{
    ...
    /// <summary>
    /// A session's authoritative size changed.
    /// </summary>
    ...
    /// <summary>
    /// A tab became the active tab of its session.
    /// </summary>
    ...
    /// <summary>
    /// A tab's settings changed, such as synchronized input.
    /// </summary>
    ...
    /// <summary>
    /// A block's title changed.
    /// </summary>
    public const string BlockTitled = "block.titled";

    /// <summary>
    /// A block setting changed, such as its synchronized input membership.
    /// </summary>
    public const string BlockChanged = "block.changed";

    /// <summary>
    /// A block's process exited.
    /// </summary>
    ...
    /// <summary>
    /// A block became the active block of its tab.
    /// </summary>
    public const string BlockFocused = "block.focused";

    /// <summary>
    /// A block produced output; throttled and carrying the latest revision.
    /// </summary>
    public const string BlockOutput = "block.output";

    /// <summary>
    /// A tab's geometry changed.
    /// </summary>
    ...
    /// <summary>
    /// The subscriber caught up after a pause.
    /// </summary>
