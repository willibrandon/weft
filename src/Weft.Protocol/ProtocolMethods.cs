...
{
    /// <summary>
    /// Returns server identity and counts.
    /// </summary>
    ...
    /// <summary>
    /// Closes a session and its blocks.
    /// </summary>
    public const string SessionClose = "session.close";

    /// <summary>
    /// Registers a client viewport on a session.
    /// </summary>
    ...
    /// <summary>
    /// Splits a block to create another.
    /// </summary>
    ...
    /// <summary>
    /// Sets a block's title.
    /// </summary>
    public const string BlockRename = "block.rename";

    /// <summary>
    /// Focuses a block, optionally by direction.
    /// </summary>
    public const string BlockFocus = "block.focus";

    /// <summary>
    /// Toggles or sets zoom on a block.
    /// </summary>
    ...
    /// <summary>
    /// Returns a floating block to the tiled layout.
    /// </summary>
    public const string BlockTile = "block.tile";

    /// <summary>
    /// Moves or resizes a floating block.
    /// </summary>
    public const string BlockMove = "block.move";

    /// <summary>
    /// Sends named keys and text to a block.
    /// </summary>
    ...
    /// <summary>
    /// Pastes text into a block with bracketed paste when supported.
    /// </summary>
    public const string BlockPaste = "block.paste";

    /// <summary>
    /// Captures a block's screen and optional history.
    /// </summary>
    public const string BlockCapture = "block.capture";

    /// <summary>
    /// Waits for a pattern, exit, or change on a block.
    /// </summary>
    public const string BlockWait = "block.wait";

    /// <summary>
    /// Runs a command in a new block and awaits its exit.
    /// </summary>
    public const string BlockRun = "block.run";

    /// <summary>
    /// Gets a tab's layout and geometry.
    /// </summary>
